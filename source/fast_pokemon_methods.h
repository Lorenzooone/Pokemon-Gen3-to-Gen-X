...
static __attribute__((optimize(3), always_inline)) u8 get_nature_fast(u32 pid){
...
static __attribute__((optimize(3), always_inline)) u8 get_unown_letter_gen3_fast(u32 pid){
