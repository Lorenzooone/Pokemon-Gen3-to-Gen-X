...
#define JAPANESE_Y_AUTO_INCREASE_SPRITES (IS_SYS_LANGUAGE_JAPANESE ? (1<<3) : 0)

#define BASE_Y_SPRITE_TRADE_ANIMATION_SEND ((SCREEN_HEIGHT>>1)-((POKEMON_SPRITE_Y_TILES<<3)>>1)-(IS_SYS_LANGUAGE_JAPANESE ? JAPANESE_Y_AUTO_INCREASE_SPRITES : 0))
